...
if args.mitigation_bypass:
    assert args.mitigation_bypass == [MitigationBypass.rwx.name]
    assert not args.hooks_configuration, "Currently hooks configuration is not supported with configuration bypass"
    args.hooks_configuration = rwx_bypass.__file__
