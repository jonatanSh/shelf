...
mips_%:
	...
	python3 -m elf_to_shellcode --input ../outputs/$(OUTPUT_DIRECTORY)$(subst mips_,,$@)_mipsbe_eshelf.out --arch mips --endian big --output ../outputs/$(OUTPUT_DIRECTORY)$(subst mips_,,$@)_mipsbe.out.shellcode.hook_support.eshelf --output-format eshelf --loader-supports hooks --hooks-configuration ../hook_configurations/test.json
