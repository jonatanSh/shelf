...
aarch_64_%:
	$(AARCH64_CC) $(CFLAGS) $(subst aarch_64_,,$@).c -o $(OUTPUT_DIRECTORY)$(subst aarch_64_,,$@)_aarch_64.out
	python -m elf_to_shellcode ../outputs/$(OUTPUT_DIRECTORY)$(subst aarch_64_,,$@)_aarch_64.out aarch_64 little ../outputs/$(OUTPUT_DIRECTORY)$(subst aarch_64_,,$@)_aarch_64.out.shellcode
